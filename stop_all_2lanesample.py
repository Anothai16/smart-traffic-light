...
NODES = [
    ...
    { "ip": "192.168.1.203", "username": "pi5node2", "password": "pi51234", "script_path": "~/Desktop/main/2lanesample.py" },
    # { "ip": "192.168.1.204", "username": "pi5node3", "password": "pi51234", "script_path": "~/Desktop/main/2lanesample.py" },
    { "ip": "192.168.1.205", "username": "pi5node4", "password": "pi51234", "script_path": "~/Desktop/main/2lanesample.py" }
]
...
def stop_node(node):
    ...
    try:
        ...
        command = "pkill -f 2lanesample.py"
